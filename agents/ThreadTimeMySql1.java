...
/**
 * la classe permet d'exécuter la méthode performanceIndicator() de la classe PerformanceIndicatorMySql plusiers fois grâce au thread 
	...
	public void run(){
		...
		while(true) {
			 try {
					...
					/**
					 * Appelle la méthode performanceIndicator() de la classe PerformanceIndicatorMySql
					 */
