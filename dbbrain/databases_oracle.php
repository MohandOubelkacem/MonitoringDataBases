...
<?php
              ...
              //$json = '{"expires_in":5180976,"access_token":"AQXzQgKTpTSjs-qiBh30aMgm3_Kb53oIf-VA733BpAogVE5jpz3jujU65WJ1XXSvVm1xr2LslGLLCWTNV5Kd_8J1YUx26axkt1E-vsOdvUAgMFH1VJwtclAXdaxRxk5UtmCWeISB6rx6NtvDt7yohnaarpBJjHWMsWYtpNn6nD87n0syud0"}';
               ...
               $json = file_get_contents('http://localhost/dbbrain1/json/oracleDB_performances.json');  

              /*
              $json = file_get_contents('http://localhost/dbbrain1/json/oracleDB_performances.json');
              */

              $json1 = file_get_contents('http://localhost/dbbrain1/json/oracleDB_evaluate.json');
             /** $json1 = file_get_contents('http://localhost/Projet_20/DBbrain/dbbrain1/json/oracleDB_evaluate.json');
             **/
									...
									<div class="card-body">
										<div class="default-tab">
											...
											<div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <a href="data_root_oracle.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 1</h3>
                                                    ...
                                                    <!--<div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 2</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 3</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 4</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 5</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 6</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 7</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 8</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Oracle 9</h3>
                                                ...
                                                <?php 
                                              /* nous parcourons le fichier json1 (oracleDB_evaluate:indicateurs globaux)
                                              ...
                                              */
                                                    foreach ($json1 as $id=>$reference) {
                                                        if ($id=='physical reads')
                                                        $var1 =  $reference;
                                                        if ($id=='logical reads')
                                                        $var3 =  $reference;
                                                        if ($id=='ccwait')
                                                        ...
                                                        /*si var2(ccwait) est supérieure à un seuil ici par exemple  1353080(on peut changer)
                                                    ...
                                                    {  if ($var3 > 2439347) 
                                                    {  /*si var3(session logical reads) est supérieure à un seuil ici par exemple 2439347(on peut changer)
                                                    ...
                                                    /*  si var4(num rows) est supérieure à un seuil ici par exemple 3231525(on peut changer)
                                                    on affiche un cas de dispersion
                                                     */ 
                                                    {
                                                        if ($var4 > 3231525) 
                                                    { 
