...
<head>
    ...
    function ()
    {
    $('#graph').load('localmongodb.php').fadeIn("slow");
    $('#graph1').load('callsmongodb.php').fadeIn("slow");
    }, 1000);
                    ...
                    <div class="row">
                                                                    ...
                                                                    <div class="card-body card-block">
                                                                        <form action="" method="post" class="">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <label type="text" id="username" name="username" class="form-control"><?php echo "9be92410-39aa-4467-8d28-4fcb7356903f";?></label>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <p class="text-muted m-b-15"><?php echo "query";?></p>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                            <div class="col-lg-12">
