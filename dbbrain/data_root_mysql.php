...
<?php 
        ...
        $json = file_get_contents('http://localhost/dbbrain1/json/Os_performances.json');
        $json1 = file_get_contents('http://localhost/dbbrain1/json/fichierMysql.json');
...
<head>
    ...
    //script de raffraichissement de la courbe
    var auto_refresh = setInterval(
    function ()
    {
    $('#graph').load('databasesinfographesmysql.php').fadeIn("slow");
    }, 1000);
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=1"><?php echo $var[0];?>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=2"><?php echo $var[1];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=3"><?php echo $var[2];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=4"><?php echo $var[3];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=5"><?php echo $var[4];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=6"><?php echo $var[5];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=7"><?php echo $var[6];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=8"><?php echo $var[7];?></a></td>
                                            ...
                                            <tr>
                                                <td><a href="queries_details_mysql.php?courbe=9"><?php echo $var[8];?></a></td>
