...
$schema = file_get_contents('schemasqlserver.json');
...
$timeSeries->AddAttribute("yAxis", "[{
                                        plot: [{
                                          value: 'Max_worker_time',
                                          connectNullData: true
                                        }],
                                        min: '3',
                                        max: '6',
                                        title: 'Max_worker_time'  
                                      }, {
                                        plot: [{
                                          value: 'Max_elapsed_time',
                                          connectNullData: true
                                        }],
                                        min: '18',
                                        max: '30',
                                        ...
                                        plot: [{
                                            value: 'Max_physical_reads',
                                            connectNullData: true
                                          }],
                                          min: '3',
                                          max: '6',
                                          title: 'Max_physical_reads'  
                                    }, {
                                        plot: [{
                                          value: 'Max_logical_reads',
                                          connectNullData: true
                                        }],
                                        min: '18',
                                        max: '30',
                                        title: 'Max_logical_reads'
                                     }]");	
...
?>
        ...
        <h3>Indicateur Max worker time, Max elapsed time, Max physical reads et Max logical reads</h3>
        <br>
