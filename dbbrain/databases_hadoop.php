...
<div class="page-wrapper">
										...
										<div class="default-tab">
											...
											<div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 1</h3>
                                                ...
                                                <!--    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 2</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 3</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 4</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 5</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 6</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 7</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 8</h3>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="data_root.php" class="au-card m-b-30">
                                                            <div class="au-card-inner">
                                                                <h3 class="title-2 m-b-40">Hadoop 9</h3>
   ...
   <img src="image/pc.jpg" class="img-circle img-rounded" width="150" height="150" alt=""  />
      ...
      <img src="image/flec1.png"  width="60" height="100" alt=""  id="p2" /><br><br><br><br><br><br>
      <img src="image/Photo.png"    width="200" height="100" alt="" id="p"/><br><br><br><br><br>
      <img src="image/flec.png"  width="60" height="100" alt="" id="p1"/>
      <img src="image/flec1.png"  width="60" height="100" alt=""  id="p2" /><br><br><br><br><br><br><br>
