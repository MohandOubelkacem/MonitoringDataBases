...
<?php 
        ...
        $json = file_get_contents('http://localhost/dbbrain1/json/DonneeOpeSys.json');
        $json1 = file_get_contents('http://localhost/dbbrain1/json/PerformanceMysql.json');
...
<head>
    ...
    function ()
    {
    $('#graph').load('databasesinfographesmysql2.php').fadeIn("slow");
    }, 1000);
