...
session_start(); 
    ...
    $bdd = new PDO('mysql:host=localhost;dbname=BDSiteWeb;charset=utf8', 'root', '');
    ...
    if(isset($recherche))
    {
        ...
        if(!empty($_POST['rech'])){
            ...
            $req = "SELECT * FROM registration LIKE '%$recherche%'";
                    
        }

        else
        {
            $errors = "Veuillez rentrer votre recherche !";
        }
    }
    else{    
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                ...
                                <button class="au-btn--submit" type="submit" value="recherche" name="rech">
